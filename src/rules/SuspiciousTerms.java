...
public class SuspiciousTerms implements Rule{
    ...
    private static final List<String> HIGH_RISK_TERMS = List.of("bloqueada", "bloqueio", "suspensa", "suspenso", "cancelado", "conta encerrada", "última chance", "acesso será restrito");
    private static final List<String> LOW_RISK_TERMS = List.of("hoje", "agora", "urgente", "imediatamente", "rápido", "não perca tempo");
